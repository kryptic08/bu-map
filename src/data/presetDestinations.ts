...
export const PRESET_DESTINATIONS: PresetDestination[] = [
  ...
  },
  {
    ...
    summary:
      "Academic building housing computer studies and engineering departments with computer labs.",
    details: [],
    keywords: [
      "computer",
      "engineering",
  ...
  },
  {
    ...
    image: destinationComputerStudiesImage,
    summary:
      "Main academic building with campus library on 2nd floor, chemistry labs, and teacher education department.",
    details: [],
    keywords: [
      "salceda",
      "salceda building",
