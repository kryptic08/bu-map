...
export const PRESET_DESTINATIONS: PresetDestination[] = [
  ...
  },
  {
    ...
    keywords: ["registrar", "records", "enrollment", "documents", "transcript", "otr", "certification", "certificate of grade", "certification of grades", "cog", "tor", "honorable dismissal", "loa", "leave of absence", "credentials", "authentication"],
  },
  {
  ...
  },
  {
    ...
    summary:
      "Electronics Technology facilities are located within the CESD Building.",
    details: [
    ...
    keywords: ["technological", "technology", "tech department", "etd", "electronics technology department", "electronics technology building"],
  },
  {
